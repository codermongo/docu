...
This script disables GameDVR, Game Bar, and associated protocols to prevent overlay popups.

## Location

[Github[MS-Gambar_Overlay_Override.ps1]](https://github.com/codermongo/docu/blob/main/Scripts/Windows/MS-Gambar_Overlay_Override.ps1)

## Prerequisites

*   **Administrator Privileges:** The script must be run as Administrator because it modifies the Registry (HKCR).
*   **PowerShell:** Windows PowerShell 5.1 or later.

## Usage

1.  Download the script or copy the code below.
2.  Open PowerShell as Administrator.
3.  Run the script: `.\MS-Gambar_Overlay_Override.ps1`
